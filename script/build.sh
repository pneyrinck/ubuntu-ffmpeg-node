...
# the latest x265 had a compatibility problem with ffmpeg so clone from stable
hg clone -r 1f0d4de https://bitbucket.org/multicoreware/x265
...
./configure --extra-libs="-ldl" --enable-gpl --enable-libass --enable-libfdk-aac --enable-libmp3lame --enable-libopus --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-nonfree --enable-openssl
make -j 8
make install
